        ...
        <div className="my-4 flex items-center">
            <Card className="class-form-card">
                <CardHeader className="relative z-10">
                    <CardTitle className="text-2xl pb-0 font-bold">Fill out the form
                    </CardTitle>
                </CardHeader>
                       ...
                       <Form {...form}>
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                              ...
                              <FormField 
                                ...
                                render={({field})=>(    
                                    <FormItem>
                                        <FormLabel>Class Name <span className="text-origin-600"></span></FormLabel>
                                        <FormControl>
                            ...
                            <FormField 
                                ...
                                render={({field})=>(    
                                    <FormItem>
                                        <FormLabel>Subject <span className="text-origin-600"></span></FormLabel>
